    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                CustomTextView(title: "For more information please call to our custome service", fontSize: 10, isBold: true, textColor: .black)
    ...
    var body: some View {
        ...
        HStack {
            ...
            Button {
                ...
                VStack {
                    CustomTextView(title: "Available Products", fontSize: 16, isBold:false, textColor: .black)
                    HStack {
